...
class LoginCubit extends Cubit<LoginState>{
  ...
  LoginCubit(this._signInWithEmailAndPasswordUseCase, this._authenticationCubit) : super(LoginInitialState());
  ...
  Future<void> signIn({required String email, required String password}) async{
    try {
      ...
      await _signInWithEmailAndPasswordUseCase(email: email, password: password);
